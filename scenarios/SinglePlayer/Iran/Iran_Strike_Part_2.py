...
def CreateScenario(SM):
    ...
    SM.SetStartTheater(49.029167, 28.737503) # (lon, lat) in degrees, negative is West or South
    ...
    SM.AddToUnitMagazine('Riyadh', 'Chaff-1', 10000)
    SM.AddToUnitMagazine('Riyadh', 'Flare-1', 10000)
    SM.AddToUnitMagazine('Riyadh', 'AIM-9M', 100)
    SM.AddToUnitMagazine('Riyadh', 'AIM-120C', 100)
    UI.AddTask('RefuelAllAircraft', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    
    SM.AddUnitToFlightDeck('Riyadh', 'F-16C', 'Zapper101', 3)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Zapper101', '2 AIM-9M;2 AIM-9M;6 Mk-82;2 1400 liter tank;6 20mm PGU;25 Flare-1;25 Chaff-1;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'F-16C', 'Zapper102', 3)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Zapper102', '2 AIM-9M;2 AIM-9M;6 Mk-82;2 1400 liter tank;6 20mm PGU;25 Flare-1;25 Chaff-1;')
    ...
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-1', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-1', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-2', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-2', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-3', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-3', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-4', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-4', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-5', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-5', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-6', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-6', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-7', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-7', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-8', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-8', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-9', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-9', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    
    SM.AddUnitToFlightDeck('Riyadh', 'Tornado GR.Mk.4', 'Striker-10', 1)
    SM.SetFlightDeckUnitLoadout('Riyadh', 'Striker-10', '2 330 gallon wing tank;2 GBU-32;2 GBU-32;2 AIM-9L;2 Skyflash;2 Skyflash;')
    ...
    SM.AddToUnitMagazine("Ganaveh", '330 gallon wing tank', 102)
    ...
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Patrol Boat 2", '9M33M', 20)
    SM.AddToUnitMagazine("Patrol Boat 2", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    ...
    unit.SetPosition(52.722890, 31.751716, 5274.4)
    unit.heading = 12.00
    unit.speed = 200.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    unit.SetPosition(48.848548, 30.507711, 9973.6)
    unit.heading = 12.00
    unit.speed = 200.0
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'Kh-31P', 3)
    ...
    unit.SetPosition(50.240893, 32.160981, 3551.2)
    unit.heading = 12.00
    unit.speed = 200.0
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'Kh-31P', 3)
    ...
    unit.SetPosition(50.987342, 32.427693, 4020.4)
    unit.heading = 12.00
    unit.speed = 200.0
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'Kh-31P', 3)
    ...
    unit.SetPosition(51.999931, 32.281759, 5106.4)
    unit.heading = 12.00
    unit.speed = 200.0
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'R-60', 2)
    ...
    goal_temp = SM.DestroyGoal('Nuclear Weapons Facility')
    goal_0_0 = goal_temp

    goal_temp = SM.DestroyGoal('Nuclear Power Plant')
    goal_0_1 = goal_temp

    goal_temp = SM.DestroyGoal('HQ Revolutionary Guards')
    goal_0_2 = goal_temp
    ...
    goal_temp = SM.ProtectGoal('Nuclear Weapons Facility')
    goal_1_0 = goal_temp

    goal_temp = SM.ProtectGoal('Nuclear Power Plant')
    goal_1_1 = goal_temp

    goal_temp = SM.ProtectGoal('HQ Revolutionary Guards')
    goal_1_2 = goal_temp
