...
def CreateScenario(SM):
    ...
    SM.SetDateTime(2008,8,8,8,8,8)
    SM.SetStartTheater(4.529167, 59.237499) # (lon, lat) in degrees, negative is West or South
    ...
    SM.SetUnitLauncherItem(unit.unitName, 5, 'LOFAR (105) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 6, 'DICASS (105) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 7, 'DIFAR (105) Sonobuoy', 15)
    ...
    SM.AddToUnitMagazine("USS Cushing", 'LOFAR (105) Sonobuoy', 263)
    SM.AddToUnitMagazine("USS Cushing", 'DICASS (105) Sonobuoy', 263)
    SM.AddToUnitMagazine("USS Cushing", 'DIFAR (105) Sonobuoy', 788)
    ...
    SM.SetFlightDeckUnitLoadout('USS Cushing', 'Spruance VLS 93 DDG Seahawk 1', '1 Mk-46 Mod5;1 120 gallon tank;1 Mk-46 Mod5;25 Chaff-1;25 Chaff-1;5 DICASS (105) Sonobuoy;5 LOFAR (105) Sonobuoy;15 DIFAR (105) Sonobuoy;')
    
    SM.AddUnitToFlightDeck('USS Cushing', 'SH-60B', 'Spruance VLS 93 DDG Seahawk 2', 1)
    SM.SetFlightDeckUnitLoadout('USS Cushing', 'Spruance VLS 93 DDG Seahawk 2', '1 Mk-46 Mod5;1 120 gallon tank;1 Mk-46 Mod5;25 Chaff-1;25 Chaff-1;5 DICASS (105) Sonobuoy;5 LOFAR (105) Sonobuoy;15 DIFAR (105) Sonobuoy;')
    ...
    SM.AddToUnitMagazine("USS Hawes", 'DICASS (105) Sonobuoy', 105)
    SM.AddToUnitMagazine("USS Hawes", 'LOFAR (105) Sonobuoy', 105)
    SM.AddToUnitMagazine("USS Hawes", 'DIFAR (105) Sonobuoy', 315)
    ...
    SM.SetFlightDeckUnitLoadout('USS Hawes', 'Perry FFG Seahawk 101', '1 Mk-46 Mod5;1 120 gallon tank;1 Mk-46 Mod5;25 Chaff-1;25 Flare-1;5 DICASS (105) Sonobuoy;5 LOFAR (105) Sonobuoy;15 DIFAR (105) Sonobuoy;')
    ...
    lat_deg = 57.296*leader_track.Lat + 0.0512
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = 90.00
    unit.speed = 3.0
    SM.AddUnitToAlliance(unit, 1)
    ...
    SM.AddToUnitMagazine("USS McInerney", 'DICASS (105) Sonobuoy', 105)
    SM.AddToUnitMagazine("USS McInerney", 'LOFAR (105) Sonobuoy', 105)
    SM.AddToUnitMagazine("USS McInerney", 'DIFAR (105) Sonobuoy', 315)
    ...
    SM.SetFlightDeckUnitLoadout('USS McInerney', 'Perry FFG Seahawk 1', '1 Mk-46 Mod5;1 120 gallon tank;1 Mk-46 Mod5;25 Chaff-1;25 Flare-1;5 DICASS (105) Sonobuoy;5 LOFAR (105) Sonobuoy;15 DIFAR (105) Sonobuoy;')
    ...
    unit = SM.GetDefaultUnit()
    unit.className = 'Ka-25BSh'
    unit.unitName = "Guard"
    unit.SetPosition(3.968649, 61.065957, 50.0)
    unit.heading = 90.00
    unit.speed = 93.8
    SM.AddUnitToAlliance(unit, 2)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'DICASS (100) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 1, 'LOFAR (100) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 2, 'DIFAR (100) Sonobuoy', 14)
    ...
    SM.AddToUnitMagazine("Vorovskiy", 'DICASS (100) Sonobuoy', 105)
    SM.AddToUnitMagazine("Vorovskiy", 'LOFAR (100) Sonobuoy', 105)
    SM.AddToUnitMagazine("Vorovskiy", 'DIFAR (100) Sonobuoy', 294)
    ...
    SM.SetFlightDeckUnitLoadout('Vorovskiy', 'Nerey Ka-27 1', '5 DICASS (100) Sonobuoy;5 LOFAR (100) Sonobuoy;14 DIFAR (100) Sonobuoy;2 APR-2E;')
    ...
    lat_deg = 57.296*leader_track.Lat + -0.0583
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = 90.00
    unit.speed = 3.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Burun", '9M33M', 20)
    SM.AddToUnitMagazine("Burun", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    UI.AddTask('EngageAll', 2.000000, 0)
    UI.AddTask('MissileWarning', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    ...
    lat_deg = 57.296*leader_track.Lat + -0.0412
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = 90.00
    unit.speed = 3.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    SM.SetUnitLauncherItem(unit.unitName, 4, '30mm OF-84 HE-FRAG AK-630M', 59)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Moroz", '9M33M', 20)
    SM.AddToUnitMagazine("Moroz", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    UI.AddTask('EngageAll', 2.000000, 0)
    UI.AddTask('MissileWarning', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    leader_id = UI.LookupFriendlyId('Vorovskiy')
    ...
    lat_deg = 57.296*leader_track.Lat + -0.0277
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = 90.00
    unit.speed = 3.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    SM.SetUnitLauncherItem(unit.unitName, 4, '30mm OF-84 HE-FRAG AK-630M', 59)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Shtil", '9M33M', 20)
    SM.AddToUnitMagazine("Shtil", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    UI.AddTask('EngageAll', 2.000000, 0)
    UI.AddTask('MissileWarning', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    leader_id = UI.LookupFriendlyId('Vorovskiy')
    ...
    lat_deg = 57.296*leader_track.Lat + -0.0313
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = 90.00
    unit.speed = 3.0
    SM.AddUnitToAlliance(unit, 2)
    ...
    SM.SetUnitLauncherItem(unit.unitName, 4, '30mm OF-84 HE-FRAG AK-630M', 59)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Mirazh", '9M33M', 20)
    SM.AddToUnitMagazine("Mirazh", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    UI.AddTask('EngageAll', 2.000000, 0)
    UI.AddTask('MissileWarning', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    leader_id = UI.LookupFriendlyId('Vorovskiy')
    ...
    SM.SetUnitLauncherItem(unit.unitName, 3, 'P-120 Malakhit', 6)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Patrol Boat 2", '30mm OF-84 HE-FRAG AK-630M', 236)
    UI.AddTask('MissileWarning', 3.000000, 3)
    UI.AddTask('Nav', 1.000000, 0)
    ...
    SM.SetUnitLauncherItem(unit.unitName, 4, '30mm OF-84 HE-FRAG AK-630M', 59)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Patrol Boat 1", '9M33M', 20)
    SM.AddToUnitMagazine("Patrol Boat 1", '30mm OF-84 HE-FRAG AK-630M76.2mm OS-62 FRAG', 152)
    UI.AddTask('MissileWarning', 3.000000, 3)
    UI.AddTask('Nav', 1.000000, 0)
    ...
    goal_temp = SM.DestroyGoal('Moroz')
    goal_10_0 = goal_temp

    goal_temp = SM.DestroyGoal('Shtil')
    goal_10_1 = goal_temp

    goal_temp = SM.DestroyGoal('Mirazh')
    goal_10_2 = goal_temp

    goal_temp = SM.DestroyGoal('Vorovskiy')
    goal_10_3 = goal_temp

    goal_temp = SM.DestroyGoal('Liven')
    goal_10_4 = goal_temp

    goal_temp = SM.ProtectGoal('USS Cushing')
    goal_10_5 = goal_temp

    goal_temp = SM.TimeGoal()
    goal_temp.SetPassTimeout(14400.0)
    goal_temp.SetFailTimeout(14400.0)
    goal_10_6 = goal_temp

    goal_temp = SM.CompoundGoal(0)
    goal_temp.AddGoal(goal_10_0)
    goal_temp.AddGoal(goal_10_1)
    goal_temp.AddGoal(goal_10_2)
    goal_temp.AddGoal(goal_10_3)
    goal_temp.AddGoal(goal_10_4)
    goal_temp.AddGoal(goal_10_5)
    goal_temp.AddGoal(goal_10_6)
    ...
    goal_temp = SM.DestroyGoal('USS McInerney')
    goal_11_0 = goal_temp

    goal_temp = SM.DestroyGoal('USS Hawes')
    goal_11_1 = goal_temp

    goal_temp = SM.DestroyGoal('USS Cushing')
    goal_11_2 = goal_temp

    goal_temp = SM.ProtectGoal('Vorovskiy')
    goal_11_3 = goal_temp
    ...
    goal_temp = SM.CompoundGoal(0)
    goal_temp.AddGoal(goal_11_0)
    goal_temp.AddGoal(goal_11_1)
    goal_temp.AddGoal(goal_11_2)
    goal_temp.AddGoal(goal_11_3)
    goal_temp.AddGoal(goal_11_4)
