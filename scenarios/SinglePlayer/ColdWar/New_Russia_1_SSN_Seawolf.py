...
def CreateScenario(SM):
    ...
    SM.SetStartTheater(31.562502, 43.970833) # (lon, lat) in degrees, negative is West or South
    ...
    SM.SetUnitLauncherItem(unit.unitName, 7, '53-65M', 5)
    SM.SetUnitLauncherItem(unit.unitName, 8, '53-65M', 5)
    SM.SetUnitLauncherItem(unit.unitName, 9, '9M33M', 20)
    SM.SetUnitLauncherItem(unit.unitName, 10, '9M33M', 20)
    SM.SetUnitLauncherItem(unit.unitName, 11, '5V55RM', 64)
    ...
    SM.SetFlightDeckUnitLoadout('Moskva', 'Atlant Ka-27 101', '14 DIFAR (100) Sonobuoy;5 DICASS (100) Sonobuoy;5 LOFAR (100) Sonobuoy;2 APR-2E;')
    ...
    SM.SetUnitLauncherItem(unit.unitName, 4, '53-65M', 1)
    SM.SetUnitLauncherItem(unit.unitName, 5, '53-65M', 1)
    SM.SetUnitLauncherItem(unit.unitName, 6, '9M32M Strela 3', 1)
    UI = SM.GetUnitInterface(unit.unitName)
    ...
    SM.SetUnitLauncherItem(unit.unitName, 1, '30mm OF-84 HE-FRAG AK-630M', 59)
    SM.SetUnitLauncherItem(unit.unitName, 2, '30mm OF-84 HE-FRAG AK-630M', 59)
    SM.SetUnitLauncherItem(unit.unitName, 3, '53-65M', 4)
    SM.SetUnitLauncherItem(unit.unitName, 4, '53-65M', 4)
    ...
    SM.SetFlightDeckUnitLoadout('Admiral Chabanenko', 'Fregat-M Ka-27 2', '14 DIFAR (110) Sonobuoy;5 LOFAR (100) Sonobuoy;5 DICASS (100) Sonobuoy;2 APR-2E;')
    ...
    SM.AddToUnitMagazine("Sevastopol AB", 'DICASS Sonobuoy', 66)
    SM.AddToUnitMagazine("Sevastopol AB", 'DIFAR (105) Sonobuoy', 18)
    SM.AddToUnitMagazine("Sevastopol AB", 'DIFAR Sonobuoy', 100)
    SM.AddToUnitMagazine("Sevastopol AB", 'LOFAR (105) Sonobuoy', 66)
    SM.AddToUnitMagazine("Sevastopol AB", 'LOFAR (110) Sonobuoy', 100)
    SM.AddToUnitMagazine("Sevastopol AB", 'DIFAR (100) Sonobuoy', 82)
    SM.AddToUnitMagazine("Sevastopol AB", 'LOFAR (100) Sonobuoy', 34)
    SM.AddToUnitMagazine("Sevastopol AB", 'DICASS (100) Sonobuoy', 34)
    SM.AddToUnitMagazine("Sevastopol AB", '1150 Liter Tank', 62)
    SM.AddToUnitMagazine("Sevastopol AB", '1520 Liter Tank', 50)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-27R', 124)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-73M', 50)
    SM.AddToUnitMagazine("Sevastopol AB", '30mm NR-30 HEI', 200)
    SM.AddToUnitMagazine("Sevastopol AB", 'Chaff-1', 300)
    SM.AddToUnitMagazine("Sevastopol AB", 'Flare-1', 200)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-73', 100)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-73M2', 50)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-77PL', 202)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-27RE', 50)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-27T', 50)
    SM.AddToUnitMagazine("Sevastopol AB", 'R-27TE', 50)
    SM.AddToUnitMagazine("Sevastopol AB", 'FAB-100', 36)
    UI.AddTask('RefuelAllAircraft', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'Il-38', 'Hammer-1', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Hammer-1', '17 DICASS (100) Sonobuoy;17 LOFAR (100) Sonobuoy;41 DIFAR (100) Sonobuoy;4 AT-2M;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'Il-38', 'Hammer-2', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Hammer-2', '17 DICASS (100) Sonobuoy;17 LOFAR (100) Sonobuoy;41 DIFAR (100) Sonobuoy;4 AT-2M;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'Il-38', 'Hammer-3', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Hammer-3', '17 DICASS Sonobuoy;17 LOFAR (105) Sonobuoy;41 DIFAR (105) Sonobuoy;4 AT-2M;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'Il-38', 'Hammer-4', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Hammer-4', '17 DICASS Sonobuoy;17 LOFAR (105) Sonobuoy;41 DIFAR (105) Sonobuoy;4 AT-2M;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-1', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-1', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-2', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-2', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-3', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-3', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-4', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-4', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-5', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-5', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    
    SM.AddUnitToFlightDeck('Sevastopol AB', 'MiG-29M', 'Arrow-6', 2)
    SM.SetFlightDeckUnitLoadout('Sevastopol AB', 'Arrow-6', '20 30mm NR-30 HEI;30 Flare-1;30 Chaff-1;1 1520 Liter Tank;2 R-77PL;2 R-77PL;2 R-77PL;2 R-77PL;')
    ...
    unit.cost = 20000000.0
    SM.AddUnitToAlliance(unit, 1)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'DIFAR (100) Sonobuoy', 13)
    SM.SetUnitLauncherItem(unit.unitName, 1, 'DICASS (100) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 2, 'DIFAR (100) Sonobuoy', 5)
    ...
    unit.cost = 20000000.0
    SM.AddUnitToAlliance(unit, 1)
    SM.SetUnitLauncherItem(unit.unitName, 0, 'DIFAR (100) Sonobuoy', 14)
    SM.SetUnitLauncherItem(unit.unitName, 1, 'DICASS (100) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 2, 'LOFAR (100) Sonobuoy', 5)
    SM.SetUnitLauncherItem(unit.unitName, 3, 'APR-2E', 2)
    UI = SM.GetUnitInterface(unit.unitName)
    UI.AddTask('AirEvade', 3.000000, 3)
    UI.AddTask('EngageAll', 2.000000, 0)
    ...
    lon_deg = 57.296*leader_track.Lon + -0.0047
    lat_deg = 57.296*leader_track.Lat + -0.0949
    unit.SetPosition(lon_deg, lat_deg, 0.0)
    unit.heading = -139.40
    unit.speed = 3.0
    unit.cost = 0.0
    ...
    UI = SM.GetUnitInterface('Moskva')
    leader_track = UI.GetTrackById(UI.GetPlatformId())
    lon_deg = 57.296*leader_track.Lon + -0.1190
    ...
    SM.SetUnitLauncherItem(unit.unitName, 2, '30mm OF-84 HE-FRAG AK-630M', 59)
    SM.SetUnitLauncherItem(unit.unitName, 3, '30mm OF-84 HE-FRAG AK-630M', 59)
    SM.SetUnitLauncherItem(unit.unitName, 4, '53-65M', 5)
    SM.SetUnitLauncherItem(unit.unitName, 5, '53-65M', 5)
    SM.SetUnitLauncherItem(unit.unitName, 6, '76.2mm OS-62 FRAG', 200)
    SM.SetUnitLauncherItem(unit.unitName, 7, '76.2mm OS-62 FRAG', 200)
    SM.SetUnitLauncherItem(unit.unitName, 8, 'V-611', 36)
    SM.SetUnitLauncherItem(unit.unitName, 9, 'V-611', 36)
    SM.SetUnitLauncherItem(unit.unitName, 10, '9M33M', 20)
    SM.SetUnitLauncherItem(unit.unitName, 11, '9M33M', 20)
    SM.SetUnitLauncherItem(unit.unitName, 12, 'RPK-3 Metel', 8)
    UI = SM.GetUnitInterface(unit.unitName)
    ...
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'Chaff-1', 10280)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'Flare-1', 9820)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'Mk-46 Mod5', 86)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'LOFAR (105) Sonobuoy', 83)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'LOFAR (110) Sonobuoy', 100)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DIFAR Sonobuoy', 150)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DIFAR (110) Sonobuoy', 100)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DIFAR (105) Sonobuoy', 300)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DICASS Sonobuoy', 183)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DICASS (110) Sonobuoy', 200)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DICASS (105) Sonobuoy', 200)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AGM-84C Harpoon', 96)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AGM-65D', 14)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'Mk-36 DST', 10)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DIFAR (100) Sonobuoy', 50)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'LOFAR (100) Sonobuoy', 17)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'DICASS (100) Sonobuoy', 17)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AGM-45A', 12)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", '20mm PGU', 40)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", '600 gallon tank', 20)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AIM-9X', 26)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AIM-120C7', 18)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AIM-120A', 12)
    SM.AddToUnitMagazine("AB Istanbul-Ataturk", 'AIM-9B', 4)
    UI.AddTask('RefuelAllAircraft', 3.000000, 3)
    BB = UI.GetBlackboardInterface()
    ...
    SM.SetFlightDeckUnitLoadout('AB Istanbul-Ataturk', 'Nail-1', '17 DICASS (100) Sonobuoy;17 LOFAR (100) Sonobuoy;50 DIFAR (100) Sonobuoy;30 Flare-1;30 Chaff-1;2 Mk-36 DST;2 Mk-36 DST;2 AIM-9B;6 Mk-36 DST;2 AGM-65D;2 AGM-65D;')
    
    SM.AddUnitToFlightDeck('AB Istanbul-Ataturk', 'P-3C III Orion', 'Nail-2', 2)
    SM.SetFlightDeckUnitLoadout('AB Istanbul-Ataturk', 'Nail-2', '17 DICASS Sonobuoy;17 LOFAR (105) Sonobuoy;50 DIFAR Sonobuoy;30 Flare-1;30 Chaff-1;2 Mk-46 Mod5;2 Mk-46 Mod5;2 Mk-46 Mod5;8 Mk-46 Mod5;2 AGM-84C Harpoon;2 AGM-84C Harpoon;')
    
    SM.AddUnitToFlightDeck('AB Istanbul-Ataturk', 'F-15C', 'Ambush-1', 2)
    SM.SetFlightDeckUnitLoadout('AB Istanbul-Ataturk', 'Ambush-1', '30 Flare-1;30 Chaff-1;4 AIM-120C7;3 600 gallon tank;2 AIM-9X;2 AIM-120C7;46 20mm PGU;')
    
    SM.AddUnitToFlightDeck('AB Istanbul-Ataturk', 'F-15C', 'Ambush-2', 2)
    SM.SetFlightDeckUnitLoadout('AB Istanbul-Ataturk', 'Ambush-2', '30 Flare-1;30 Chaff-1;4 AIM-120C7;3 600 gallon tank;2 AIM-9X;2 AIM-120C7;46 20mm PGU;')
    
    SM.AddUnitToFlightDeck('AB Istanbul-Ataturk', 'E-3D/F', 'Hole-1', 2)
    SM.SetFlightDeckUnitLoadout('AB Istanbul-Ataturk', 'Hole-1', '')
    
    unit = SM.GetDefaultUnit()
    unit.className = 'Seawolf'
    ...
    goal_temp.AddGoal(goal_27_0)
    goal_temp.AddGoal(goal_27_1)
    goal_temp.AddGoal(goal_27_2)
