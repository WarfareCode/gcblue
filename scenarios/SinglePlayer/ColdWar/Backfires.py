...
def CreateScenario(SM):
    ...
    SM.SetUnitLauncherItem(unit.unitName, 5, 'Flare-1', 25)
    UI = SM.GetUnitInterface(unit.unitName)
    UI.AddTask('AirEvade', 3.000000, 3)
    UI.AddTask('EngageAll', 2.000000, 0)
    UI.AddTask('JetTakeoff', 2.000000, 0)
    ...
    SM.AddToUnitMagazine("Kevlavik", 'R-73U', 300)
    ...
    SM.SetFlightDeckUnitLoadout('Kevlavik', 'Shadow-3', '0 Empty;2 R-27R;2 R-73;2 R-73M;25 Chaff-1;25 Flare-1;')
    
    SM.AddUnitToFlightDeck('Kevlavik', 'MiG-29', 'Shadow-2', 1)
    SM.SetFlightDeckUnitLoadout('Kevlavik', 'Shadow-2', '0 Empty;2 R-27R;2 R-73;2 R-73M;25 Chaff-1;25 Flare-1;')
    
    SM.AddUnitToFlightDeck('Kevlavik', 'MiG-29', 'Shadow-8', 1)
    SM.SetFlightDeckUnitLoadout('Kevlavik', 'Shadow-8', '0 Empty;2 R-27R;2 R-73;2 R-73M;25 Chaff-1;25 Flare-1;')
    
    SM.AddUnitToFlightDeck('Kevlavik', 'MiG-29', 'Shadow-11', 1)
    SM.SetFlightDeckUnitLoadout('Kevlavik', 'Shadow-11', '0 Empty;2 R-27R;2 R-73;2 R-73M;25 Chaff-1;25 Flare-1;')
    ...
    SM.AddUnitToAlliance(unit, 2)
    UI = SM.GetUnitInterface(unit.unitName)
    SM.AddToUnitMagazine("Kevlavik 2", 'R-73U', 200)
