...
###### Unit menu scripts #####
def StockBuildUnitMenu(UnitMenu, UnitInfo):
    UnitMenu.Clear()
...
def BuildRefuelMenu(UnitMenu, UnitInfo):
    ...
    if (UnitInfo.TaskExists('Refuel')):
        ...
        try:
            ...
            tanker_info = landing.GetNearbyTankers(UnitInfo)
...
def BuildLandMenu(UnitMenu, UnitInfo):
    ...
    if (UnitInfo.TaskExists('Land')):
        ...
        try:
            ...
            import Landing as landing
            base_info = landing.GetNearbyAirfields(UnitInfo)
        ...
        try:
            ...
            import Landing as landing
            home_base = landing.GetHomeBase(UnitInfo)
        if (home_base != ''):
